...
void stringReverse(char* begin, char* end) { // function to reverse a string
	char aux;
	while(end>begin)
...
int main() {
    int fd;
    account_t admin_account = {0, {0}, "1", 21.}; // the balance field refers to the total number of structs in the database
    ...
    printf("Admin id = 1\nAdmin Password = 1\n\n");
    printf("Adding 4 dummy singe-user accounts...\n");
    ...
    printf("Adding 2 dummy joint-user accounts...\n"); // all with just two users
